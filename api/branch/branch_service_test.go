...
func TestGetBranchesWithLatestPipeline(t *testing.T) {
	var (
		...
		branchesLoader       = cache.NewLoadingCache[int, []model.Branch](cache.NoopLoaderFunc)
...
func TestGetBranchesWithLatestPipelineError(t *testing.T) {
	var (
		...
		pipelineLatestLoader = cache.NewLoadingCache[pipeline.Key, *model.Pipeline](cache.NoopLoaderFunc)
		branchesLoader       = cache.NewLoadingCache[int, []model.Branch](func(i int) ([]model.Branch, error) {
